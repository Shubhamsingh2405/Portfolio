      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ shubhamkumarsingh9939@gmail.com | 📞 +91 7488535121
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              ...
              , 2023–2027 <br />
              <span style={{ color: "#aaa" }}>GPA: 7.96</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>12th Board — Sree Ayyappa Public School</strong> (CBSE
              Board, 2022) <br />
              <span style={{ color: "#aaa" }}>Percentage: 84.2%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — Takshila School</strong> (CBSE Board, 2020)
              <br />
              <span style={{ color: "#aaa" }}>Percentage: 89.2%</span>
            </li>
          </ul>
        </motion.div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>1️⃣ AI-Based Water Quality & Encroachment Analysis using OpenCV</li>
            <li>2️⃣ Smart Financial Assistant Chatbot For Budget Planning(Gemini API)</li>
            <li>3️⃣ Online Payment Fraud Detection using Machine Learning</li>
        ...
        >
          {[
            { name: "🏆 LeetCode", link: "https://leetcode.com/u/shubhamkumarsingh9939/" },
            { name: "💻 GitHub", link: "https://github.com/Shubhamsingh2405" },
            { name: "💼 LinkedIn", link: "https://www.linkedin.com/in/sks24/" },
          ].map((site) => (
            <motion.a
              key={site.name}
              href={site.link}

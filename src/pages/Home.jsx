...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/Shubhamsingh2405' },
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/sks24/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:shubhamkumarsingh9939@gmail.com' },
    { img: whatsappLogo, title: 'WhatsApp', link: 'https://wa.me/+917488535121' },
    { img: instagramLogo, title: 'Instagram', link: 'https://www.instagram.com/_shub.hamm._/' },
  ]
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {[ 
              { label: '📍 Location', value: 'Gaya, Bihar, India' },
              { label: '💼 Expertise', value: 'AI/ML,Problem solving' },
              { label: '📧 Contact', value: 'shubhamkumarsingh9939@gmail.com' },
            ].map((info, i) => (
              <motion.div
                key={i}
